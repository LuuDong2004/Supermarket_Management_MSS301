...
import { Button, Badge, Field, Input, StatusBadge, Spinner } from '../../components/ui/primitives.jsx'
  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <DataTable
          rows={filtered}
          onRowClick={(r) => navigate(`/app/hr/attendance/${r.id}/edit`)}
          ...
          actions={(r) => (
            <>
              <Button size="sm" variant="secondary" icon={Pencil} onClick={() => navigate(`/app/hr/attendance/${r.id}/edit`)}>Sửa</Button>
