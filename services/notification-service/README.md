# notification-service (reserved)

Placeholder for the future **notification-service**. It is intentionally **not yet a
...
1. Scaffold the standard structure (copy `docs/architecture/SERVICE_TEMPLATE.md`):
   ...
   ```
2. Register it in the root `pom.xml` `<modules>` as `services/notification-service`.
